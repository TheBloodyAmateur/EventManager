...
class EventCreatorTest {
    ...
    void testJSONCustomLogLevel() {
        String eventCreator = new EventCreator("json").lineNumber().message("Hello, World!").args("args",new KeyValueWrapper("args", "arg1")).logLevel("CUSTOM").create();
        int lineNumber = new Throwable().getStackTrace()[0].getLineNumber() - 1;
    ...
    void testXMLCustomLogLevel() {
        String eventCreator = new EventCreator("xml").lineNumber().message("Hello, World!").args("args",new KeyValueWrapper("args", "arg1")).logLevel("CUSTOM").create();
        int lineNumber = new Throwable().getStackTrace()[0].getLineNumber() - 1;
    ...
    void testCSVCustomLogLevel() {
        String eventCreator = new EventCreator("csv").lineNumber().message("Hello World!").args("args",new KeyValueWrapper("args", "arg1")).logLevel("CUSTOM").create();
        int lineNumber = new Throwable().getStackTrace()[0].getLineNumber() - 1;
